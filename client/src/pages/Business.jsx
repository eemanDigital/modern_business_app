...
const Business = () => {
  return (
    <>
      <GeneralHero
        image={businessImg}
        title="We're the one-stop-shop for all your business formation, compliance, and trademark needs."
        parentClass='b-feature'
        ctaText='Let Help You Start Your Journey'
      />
      <section className='company-section'>
        <div className='comp-container'>
          <div className='text-1'>
            ...
            <p data-aos='zoom-in'>
              <strong>A &quot;business name&quot; in Nigeria</strong>, as
              defined by the Corporate Affairs Commission (CAC), is the official
              name under which your business operates and conducts its
              activities. It serves as a unique identifier for your company,
              separate from your personal name, and should ideally reflect your
              brand identity and the nature of your business.
            </p>
            ...
            <ul data-aos='zoom-in'>
              <li>
                ...
                <ul>
                  <li>
                    <strong>Legal Recognition:</strong> Registering your
                    business name with CAC is essential for legal recognition
                    and operation. It separates your personal assets from
                  ...
                  <li>
                    <strong>Funding:</strong> Many financial institutions
                    require registration before providing loans or investments.
                  </li>
                  <li>
                    <strong>Trademark Protection:</strong> Registration helps
                    prevent others from using similar names that could infringe
                    on your brand.
                  </li>
                </ul>
              </li>
